                   ...
                   <td colspan="3">
                       <table class="table table-hover">
                           ...
                           <tr>
                               ...
                               <td colspan="3">
                                    <input type="radio" id="moi" name="moi" value="YORUBA">YORUBA
                                    <input type="radio" id="moi" name="moi" value="HAUSA"><font style="font-family: Verdana;">HAUSA</font>
                                    <input type="radio" id="moi" name="moi" value="English"><font style="font-family: Verdana;">English</font>
                                    <input type="radio" id="moi" name="moi" value="IGBO"><font style="font-family: Verdana;">IGBO</font>
                                    <input type="radio" id="moi" name="moi" value="PIDGIN"><font style="font-family: Verdana;">PIDGIN</font>
